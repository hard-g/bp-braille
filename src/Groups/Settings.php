...
class Settings implements Registerable {
	...
	public function render() {
		...
		<label for="group-enable-braille">
			<input type="checkbox" name="group-enable-braille" id="group-enable-braille" value="1" <?php checked( $enabled ); ?> /> <?php _e( 'Show Braille toggle fo group discussions', 'bp-braille' ); ?>
		</label>
		<?php
	}
